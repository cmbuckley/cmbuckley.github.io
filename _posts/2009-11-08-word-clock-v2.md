...
categories:
  ...
  - Play
---
I've seen a few nice-looking representations of clocks around, but when I saw [Gumuz's word clock]({% include archive.html url="http://gumuz.nl/weblog/javascript-word-clock/" %}) I though I could make some improvements to it. Here's a couple of the changes:
